...
######  👉 Build or install k4a for pyk4a and set PYK4A path symbols
####### Set the library directory for k4a.lib and k4a.dll
...
pip install pyk4a --no-use-pep517 --global-option=build_ext --global-option="-ID:\k4a\install\include" --global-option="-LD:\k4a\install\lib" 
```
